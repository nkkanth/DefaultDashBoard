...
public class GamesChapterShelfRowHoverCardView extends LinearLayout {

    private TextView mTitle;
    private TextView mSubText;
    private TextView mDescription;

    public GamesChapterShelfRowHoverCardView(Context context) {
        this(context, null);
    }

    public GamesChapterShelfRowHoverCardView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public GamesChapterShelfRowHoverCardView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        LayoutInflater.from(context).inflate(R.layout.view_games_shelf_row_hovercard, this);
        mTitle = (TextView) findViewById(R.id.games_item_title);
        mSubText = (TextView) findViewById(R.id.games_shelf_item_subtext);
        mDescription = (TextView) findViewById(R.id.games_shelf_item_description);
    ...
    private void applyRtlMarginStart() {
        int rtlMarginStart = getResources().getDimensionPixelSize(R.dimen.margin_start_hover_card_rtl_games_chapter);
