...
public class RecommendedChapterShelfRowView extends LinearLayout {
    ...
    public RecommendedChapterShelfRowView(Context context) {
        this(context, null);
    }

    public RecommendedChapterShelfRowView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RecommendedChapterShelfRowView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);

        LayoutInflater.from(context).inflate(R.layout.view_recommended_chapter_shelf_row, this);
    ...
    public void onExpanded() {
        DdbLogUtility.logRecommendationChapter("RecommendedChapterShelfRowView", "onExpanded");
    ...
    public void onCollapsed() {
        DdbLogUtility.logRecommendationChapter("RecommendedChapterShelfRowView", "onCollapsed");
        LinearLayout.LayoutParams layoutParams = (LinearLayout.LayoutParams) mShelfIconImageView.getLayoutParams();
