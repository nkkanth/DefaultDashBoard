...
public class ShelfRowHoverCardView extends LinearLayout {
    ...
    public ShelfRowHoverCardView(Context context) {
        this(context, null);
    }

    public ShelfRowHoverCardView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ShelfRowHoverCardView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        LayoutInflater.from(context).inflate(R.layout.view_shelf_row_hovercard, this);
    ...
    private void applyRtlMarginStart() {
        int rtlMarginStart = getResources().getDimensionPixelSize(R.dimen.margin_start_hover_card_rtl_channels);
