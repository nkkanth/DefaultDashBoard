...
public class ChannelsShelfRowView extends LinearLayout {
    ...
    public ChannelsShelfRowView(Context context) {
        this(context, null);
    }

    public ChannelsShelfRowView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ChannelsShelfRowView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);

        LayoutInflater.from(context).inflate(R.layout.view_channels_shelf_row, this);
    ...
    public void onExpanded() {
        DdbLogUtility.logTVChannelChapter("ChannelsShelfRowView", "onExpanded");
    ...
    public void onCollapsed() {
        DdbLogUtility.logTVChannelChapter("ChannelsShelfRowView", "onCollapsed");
        LinearLayout.LayoutParams layoutParams = (LinearLayout.LayoutParams) mShelfIconImageView.getLayoutParams();
