...
public class SidePanelNonHighlightedTextColorNode extends MultiSliderNode {

    private int mCurrentColor;

    public SidePanelNonHighlightedTextColorNode(Context context) {
        this(context, null);
    }

    public SidePanelNonHighlightedTextColorNode(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SidePanelNonHighlightedTextColorNode(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        initialize();
    }

    private void initialize() {
        mCurrentColor = DashboardDataManager.getInstance().getSidePanelNonHighlightedTextColor();
    }
    ...
    public void setColorValue(Context context, int index, int value) {
        ...
        mCurrentColor = color;
        DashboardDataManager.getInstance().changeSidePanelNonHighlightedTextColor(color);
    }
    ...
    public void onDismissed() {
        DashboardDataManager.getInstance().saveSidePanelNonHighlightedTextColor(mCurrentColor);
    }
