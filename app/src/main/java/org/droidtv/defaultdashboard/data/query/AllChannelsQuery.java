...
public class AllChannelsQuery implements Query {
    ...
    public AllChannelsQuery() {
        mSelection = null;
        mSelectionArgs = null;
    }

    public AllChannelsQuery(boolean tvChannelsEnabled, boolean radioChannelsEnabled, boolean mediaChannelsEnabled, boolean tifChannesEnabled,
                            boolean hdmi1Enabled, boolean hdmi2Enabled, boolean hdmi3Enabled, boolean hdmi4Enabled, boolean vgaEnabled) {
        ArrayList<String> selectionArgs = new ArrayList<>();
        mSelectionArgs = new String[1];

        // Exclude hidden channels
        mSelection = HtvChannelList.COLUMN_HIDE.concat(" = ?");
        selectionArgs.add("0");
        ...
        if (!radioChannelsEnabled) {
            ...
            mSelection = mSelection.concat(HtvChannelList.COLUMN_SERVICE_TYPE).concat(" != ?");
        ...
        if (!mediaChannelsEnabled) {
            ...
            mSelection = mSelection.concat(HtvChannelList.COLUMN_MEDIA_TYPE).concat(" != ?");
        ...
        mSelectionArgs = (selectionArgs == null || selectionArgs.isEmpty()) ? null : selectionArgs.toArray(mSelectionArgs);
        DdbLogUtility.logTVChannelChapter("AllChannelsQuery", "AllChannelsQuery mSelectionArgs " + mSelectionArgs );
    }
